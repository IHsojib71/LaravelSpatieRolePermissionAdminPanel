    ...
    <div class="flex flex-shrink-0 items-center ml-auto">
      ...
      <div class="flex border-l pl-3 ml-3 space-x-1">
        ...
        <form method="POST" action="{{ route('logout') }}">
          @csrf
        <button type="submit" title="Logout" class="relative p-2 text-gray-400 hover:bg-gray-100 hover:text-gray-600 focus:bg-gray-100 focus:text-gray-600 rounded-full">
