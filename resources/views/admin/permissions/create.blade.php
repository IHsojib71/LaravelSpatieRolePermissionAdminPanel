<x-app-layout>
    ...
    <div class="flex flex-col space-y-6 md:space-y-0 md:flex-row justify-between">
        <div class="mr-6">
          <h1 class="text-4xl font-semibold mb-2">Create Permission</h1>
          <h2 class="text-gray-600 ml-0.5">New Permission Form</h2>
        </div>
      ...
      <section>
        <div class="rounded-lg bg-white p-4">
            <form action="{{route('admin.permissions.store')}}" method="POST" class="mx-auto mt-16 max-w-xl sm:mt-20">
                @csrf
                <div>
